...
| **html-artifact** | User wants a rich self-contained HTML file instead of markdown. Auto-detects artifact shape (spec, code-review, prototype, report, editor, data-viz, diagram, deck) and loads shape-specific patterns. Bundles Birchline/Dark Focus design system with theme toggle. Triggers: "make HTML", "as HTML", "HTML artifact", "HTML file", "self-contained HTML", "interactive document", "rich visualization", "flowchart", "architecture diagram", "SVG diagram", "slide deck", "presentation slides", "figure sheet", "sequence diagram". Category: meta. NOT: Hugo/blog HTML templates (use frontend work). NOT: PowerPoint files (use pptx-generator). |
